...
from config_IFNO import Config, load_dataset, load_dataset_train
from IFNO_2D import FNO2d, predict_model, plot_predicted_sample
...
if __name__=="__main__":
    ...
    folder_weight_path = "/home/zliu2/life_science/IFNO/weights/m12_w90_n40/"
    ...
    try: filename_weight = f"IFNO_t2m_{chosen_epoch}.pth"
