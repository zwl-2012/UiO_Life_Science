...
class FNO3d(nn.Module):
    ...
    def forward(self, x):   #[8, 32, 30, 5, 1, 1] 
        ...
        #print(batchsize, size_x, size_y, var, T_in)
...
vor_data = np.load('/home/zliu2/UiO_Life_Science/uq4downscaling/Datasets/uq4turbu_data/uq4turbu_mini_2sim_20steps/vel_2sim_20step_32x30_scalar.npy') #
...
#print(vor_data[0,0:0+T_in,...].shape) # torch.Size([1, 32, 30, 1])
